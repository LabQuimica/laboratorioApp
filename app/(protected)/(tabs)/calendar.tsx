      ...
      {selected && practicas && (
        <ScrollView className="mt-6 px-4">
          <View className='flex flex-row items-center mb-5'>
            <Text className="text-black dark:text-white text-5xl font-bold mr-7">Hoy</Text>
            <Text className='text-black dark:text-white text-xl font-thin'>
              {new Date(selected).toLocaleDateString('es-MX', { day: 'numeric', month: 'long' })}
            </Text>
          </View>
              ...
              {practicas
                ...
                .map(practica => {
                  ...
                  return (
                    ...
                    >
                      <View className="absolute -left-5 top-6 w-5 h-5 rounded-full border-2 dark:border-white border-gray-300"
                        style={{ backgroundColor: color }} />

                      <View className="bg-[#3D539F] dark:bg-[#1E1E2F] rounded-xl px-4 py-2 shadow-md">
                        <Text className="text-white font-semibold text-sm">{practica.practica_nombre}</Text>
                        <Text className="text-gray-300 text-xs">{practica.grupo_nombre}</Text>
